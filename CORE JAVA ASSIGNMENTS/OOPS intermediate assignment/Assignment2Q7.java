...
public class Assignment2Q7 {
    ...
    {
        int ch;
        System.out.println("Enter itemnumber you want to add:\n 1. for cookie \n2. for candy \n3. for icecream");
    ...
    {
        int ch;
        System.out.println("Enter itemnumber you want to order: Enter:-\n1. for cookie\n2. for candy \n3. for icecream");
    ...
    private void placeOrderOperation(int choice)
    {
        ...
        if(choice==1)
        {
            ...
            System.out.println("Your bill is : "+(qty*obj1.getCost())+" rupees");
        }
        else if(choice==2)
        {
            System.out.println("Enter how much you want to order: ");
            ...
            System.out.println("Your bill is : "+(qty*obj2.getCost())+" rupees");
        ...
        else if(choice==3)
        {
            ...
            System.out.println("Your bill is : "+(qty*obj3.getCost())+" rupees");
